...
- Controller-level FTS interruption and integration coverage, IMAP/SMTP, optional JMAP, MIME ingestion, OAuth2, and keyring integration remain planned backend slices.
